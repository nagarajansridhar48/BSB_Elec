...
import { Fridge } from '../../../assets/dummy/asset'
...
const Fridge_Section = () => {
  const [flippedCards, setFlippedCards] = useState(() => {
    const saved = localStorage.getItem("cp");
  ...
  const toggleFlip = (index) => {
    ...
    localStorage.setItem("cp", JSON.stringify(newFlipped)); // persist to localStorage
  };
  return (
    <div className="w-full py-10">
      <h1 className="w-full text-3xl font-medium mb-6">Consumer Products</h1>
