...
const TV_Section = () => {
  // Initialize flipped state from localStorage
  const [flippedCards, setFlippedCards] = useState(() => {
    const saved = localStorage.getItem("tv");
  ...
  const toggleFlip = (index) => {
    ...
    localStorage.setItem("tv", JSON.stringify(newFlipped)); // persist to localStorage
  };

  return (
    <div className="w-full md:py-10">
      <h1 className="w-full text-3xl font-medium mb-6">TV Products</h1>
