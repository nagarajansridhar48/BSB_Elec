...
import { VC } from "../../../assets/dummy/asset"; // make sure VC image is added
...
const VC_Section = () => {
  ...
  const [flippedCards, setFlippedCards] = useState(() => {
    const saved = localStorage.getItem("vc");
  ...
  const toggleFlip = (index) => {
    ...
    localStorage.setItem("vc", JSON.stringify(newFlipped)); // persist to localStorage
  };

  return (
    <div className="w-full py-10">
      <h1 className="w-full text-3xl font-medium mb-6">VC Products</h1>
