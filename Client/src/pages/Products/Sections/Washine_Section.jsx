...
import { Wash } from '../../../assets/dummy/asset';
...
const Washine_Section = () => {
  const [flippedCards, setFlippedCards] = useState(() => {
      const saved = localStorage.getItem("wc");
    ...
    const toggleFlip = (index) => {
      ...
      localStorage.setItem("wc", JSON.stringify(newFlipped)); // persist to localStorage
    };


  return (
    <div className="w-full py-10">
        <h1 className="w-full text-3xl font-medium mb-6">Washing Machines</h1>
...
export default Washine_Section;